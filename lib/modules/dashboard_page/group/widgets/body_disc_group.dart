...
class BodyDiscussionGroupePage extends GetView<ChatController> {
  final ScrollController scrollController;
  const BodyDiscussionGroupePage({Key? key, required this.scrollController})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => controller.listChatController.isEmpty
          ? const EmptyChatPage()
          : ListView.builder(
